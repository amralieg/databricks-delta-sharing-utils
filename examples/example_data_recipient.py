...
dsr = DeltaShareRecipient(share_profile_file_lo="<share-profile-location>", provider_sharing_identifier="<data-provider-sharing-identifier>", catalog="<catalog-name>")
